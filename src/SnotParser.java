...
public class SnotParser extends Parser {
	...
	public static class AndOrOrExpressionContext extends ExpressionContext {
		...
		public AndOrOrExpressionContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).enterAndOrOrExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).exitAndOrOrExpression(this);
		}
	}
	public static class MinusExpressionContext extends ExpressionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).enterMinusExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).exitMinusExpression(this);
		}
	}
	public static class ValueExpressionContext extends ExpressionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).enterValueExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).exitValueExpression(this);
		}
	}
	public static class MultDivExpressionContext extends ExpressionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).enterMultDivExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).exitMultDivExpression(this);
		}
	}
	public static class CompareExpressionContext extends ExpressionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).enterCompareExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).exitCompareExpression(this);
		}
	}
	public static class AddOrSubExpressionContext extends ExpressionContext {
		public ExpressionContext expression(int i) {
			return getRuleContext(ExpressionContext.class,i);
		}
		public List<ExpressionContext> expression() {
		...
		public AddOrSubExpressionContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).enterAddOrSubExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).exitAddOrSubExpression(this);
		}
	}
	public static class NotExpressionContext extends ExpressionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).enterNotExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).exitNotExpression(this);
		}
	}
	public static class IdExpressionContext extends ExpressionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).enterIdExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).exitIdExpression(this);
		}
	}
	public static class ParenExpressionContext extends ExpressionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).enterParenExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SnotListener ) ((SnotListener)listener).exitParenExpression(this);
		}
	}
	...
	public final ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case OPEN_PARENTHESIS:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(189); match(OPEN_PARENTHESIS);
				setState(190); expression(0);
				setState(191); match(CLOSE_PARENTHESIS);
				}
				break;
			case ID:
				{
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						{
						_localctx = new AndOrOrExpressionContext(new ExpressionContext(_parentctx, _parentState, _p));
					...
					case 2:
						...
						consume();
						setState(202); expression(6);
						}
						break;

					case 3:
						{
						_localctx = new MultDivExpressionContext(new ExpressionContext(_parentctx, _parentState, _p));
						pushNewRecursionContext(_localctx, _startState, RULE_expression);
						setState(203);
						...
						consume();
						setState(205); expression(5);
						}
						break;

					case 4:
						{
						_localctx = new AddOrSubExpressionContext(new ExpressionContext(_parentctx, _parentState, _p));
						pushNewRecursionContext(_localctx, _startState, RULE_expression);
						setState(206);
	...
	public final LoopContext loop() throws RecognitionException {
		...
		try {
			...
			case WHILE:
				...
				setState(223); match(CLOSE_CURLY);
				}
				break;
			case FOR:
				enterOuterAlt(_localctx, 2);
				...
				setState(239); match(CLOSE_CURLY);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public static final String _serializedATN =
		...
		"\3\21\3\21\3\21\3\21\3\21\3\21\7\21\u00d4\n\21\f\21\16\21\u00d7\13\21"+
		"\3\22\3\22\3\22\3\22\7\22\u00dd\n\22\f\22\16\22\u00e0\13\22\3\22\3\22"+
		"\3\22\3\22\5\22\u00e6\n\22\3\22\3\22\3\22\3\22\3\22\7\22\u00ed\n\22\f"+
		"\22\16\22\u00f0\13\22\3\22\5\22\u00f3\n\22\3\22\2\23\2\4\6\b\n\f\16\20"+
		"\22\24\26\30\32\34\36 \"\2\b\4\2\4\4\37\37\3\2\20\23\3\2\30\31\3\2\6\13"+
		"\3\2\16\17\3\2\f\r\u0108\2%\3\2\2\2\4.\3\2\2\2\6\60\3\2\2\2\bD\3\2\2\2"+
		"\nQ\3\2\2\2\fS\3\2\2\2\16U\3\2\2\2\20e\3\2\2\2\22p\3\2\2\2\24z\3\2\2\2"+
